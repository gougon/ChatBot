...
from linebot.models import FollowEvent, TextSendMessage, MessageEvent, TextMessage, PostbackEvent, TemplateSendMessage, ButtonsTemplate, PostbackTemplateAction
...
templateMessage = TemplateSendMessage(
    alt_text='AlertBot UMS Template',
...
toBeDoneMessage = TextSendMessage(text='敬請期待......')
...
def handle_postback(event):
    ...
    if command == 'ums':
        ...
        replyMessages = toBeDoneMessage
    elif command == 'report':
        replyMessages = toBeDoneMessage
    elif command == 'kvs':
        replyMessages = toBeDoneMessage

    # Template Postback Event
